...
const BalnceCardsData = () => {
    const { data, error } = useSWR('/api/admin/balance', fetcher, { refreshInterval: 10000 });
    console.log(data)
    return (
        <div className="w-full grid md:grid-cols-2 grid-cols-1 lg:grid-cols-4 gap-3 ">
            {data && <>
                <MonyCard
                    titel="Total Users hold"
